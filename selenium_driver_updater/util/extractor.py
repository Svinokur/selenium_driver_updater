...
class Extractor():
    ...
    @staticmethod
    def extract_all_zip_archive(archive_path : str, out_path : str) -> Tuple[bool, str]:
    ...
    @staticmethod
    def extract_all_tar_gz_archive(archive_path : str, out_path : str) -> Tuple[bool, str]:
    ...
    @staticmethod
    def extract_all_zip_archive_with_specific_name(archive_path : str, out_path : str, filename : str, filename_replace : str) -> Tuple[bool, str]:
        ...
        try:
            ...
            if archive_path.endswith('.tar.gz'):
                ...
                result, message = Extractor.extract_all_tar_gz_archive(archive_path=archive_path, out_path=driver_folder_path)
                if not result:
                    return result, message

            elif archive_path.endswith('.zip'):

                result, message = Extractor.extract_all_zip_archive(archive_path=archive_path, out_path=driver_folder_path)
                if not result:
                    return result, message
