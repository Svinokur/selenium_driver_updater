...
class testChromeDriver(unittest.TestCase): 
    ...
    #@unittest.skip('Temporary not needed')
    def test03_check_get_latest_chromedriver_for_current_os_failure(self):
        result, message, file_name = self.chrome_driver_failure._ChromeDriver__get_latest_chromedriver_for_current_os(latest_version=self.specific_version_failure)
        self.assertFalse(result, result)
        self.assertGreater(len(message), 0, len(message))
        self.assertEqual(len(file_name), 0, len(file_name))
    ...
    #@unittest.skip('Temporary not needed')
    def test05_check_chromedriver_is_up_to_date_failure(self):
    ...
    #@unittest.skip('Temporary not needed')
    def test08_check_get_result_by_request(self):
    ...
    #@unittest.skip('Temporary not needed')
    def test10_check_get_specific_version_chromedriver_for_current_os(self):
    ...
    #@unittest.skip('Temporary not needed')
    def test13_check_get_latest_chromedriver_for_current_os(self):
        result, message, latest_version = self.chrome_driver._ChromeDriver__get_latest_version_chrome_driver()
        self.assertTrue(result, message)
        self.assertIsNotNone(latest_version, latest_version)
        self.assertGreater(len(latest_version), 0, len(latest_version))
    ...
    #@unittest.skip('Temporary not needed')
    def test16_check_get_latest_version_chrome_browser(self):
    ...
    def test17_check_get_latest_chrome_browser_for_current_os(self):
        result, message = self.chrome_driver._ChromeDriver__get_latest_chrome_browser_for_current_os()
        self.assertTrue(result, message)

    
    #@unittest.skip('Temporary could not test it on Github Workflow')
    def test18_check_compare_current_version_and_latest_version_chrome_browser(self):
    ...
    #@unittest.skip('Temporary not needed')
    def test19_check_chromedriver_is_up_to_date(self):
