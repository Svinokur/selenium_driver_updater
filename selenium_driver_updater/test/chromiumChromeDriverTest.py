...
class testChromiumChromeDriver(unittest.TestCase): 
    ...
    def test02_check_get_current_version_chromium_chromedriver(self):
        current_version = self.chromium_chromedriver._ChromiumChromeDriver__get_current_version_chromium_chromedriver()
    ...
    def test05_check_compare_current_version_and_latest_version(self):
        is_driver_is_up_to_date, current_version, latest_version = self.chromium_chromedriver._ChromiumChromeDriver__compare_current_version_and_latest_version()
