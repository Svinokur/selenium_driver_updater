...
class testDriverUpdater(unittest.TestCase):
    ...
    #@unittest.skip('Temporary not needed')
    def test03_check_system_name_is_valid_failure(self):
        try:
    ...
    #@unittest.skip('Temporary not needed')
    def test04_check_parameter_type_is_valid(self):
        try:
